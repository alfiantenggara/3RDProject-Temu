...
import 'package:temu_app/model/bayar.dart';
import 'package:temu_app/pages/paymentbill.dart';
...
class _BeriUangPageState extends State<BeriUangPage> {
  ...
  void navigateToPaymentBill() {
    ...
    DetailPembayaran detailPembayaran = DetailPembayaran(
      idPembayaran: 'P12345', // Contoh ID Pembayaran
      idRekeningTemu: 'RT67890', // Contoh ID Rekening Temu
      biayaSponsor: biayaSponsor,
      biayaLayanan: 50000, // Biaya layanan (contoh)
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => PaymentBillPage(
